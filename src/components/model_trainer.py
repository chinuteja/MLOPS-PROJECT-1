...
class ModelTrainer:
    ...
    def initiate_model_trainer(self) -> ModelTrainerArtifact:
        ...
        try:
            ...
            metric_artifact_dict = metric_artifact.__dict__
            logging.info(f"Model metric artifact: {metric_artifact_dict}")
            write_yaml_file(file_path=self.model_trainer_config.metric_report_file_path, content=metric_artifact_dict, replace=True)
