...
from src.constants import DATABASE_NAME, MONGODB_URL_KEY,MONGODB_URL_KEY
    ...
    def __init__(self, database_name: str = DATABASE_NAME) -> None:
        ...
        try:
            ...
            if MongoDBClient.client is None:
                #MONGODB_URL_KEY = "mongodb+srv://chinuteja2008_db_user:V5Ohuwc38w1vZEJO@cluste0.qzwrliv.mongodb.net/?appName=Cluste0" ## added temporarily for testing purpose, please remove it and set the environment variable in your system
